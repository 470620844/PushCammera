...
import org.easydarwin.easyipcamera.util.ScreenUtil;
...
//    SurfaceView mSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkSettingAlertPermission(getApplicationContext());
        createDialog();
...
//        mSurfaceView.setOnClickListener(this);
        ...
        mMediaStream = new MediaStream(getApplicationContext(), svSmall);
...
//        }
        ...
        switch (v.getId()) {
            case R.id.btn_switch:
                ...
                if (!mMediaStream.isOpen()) {
                    ...
                    svSmall.setBackgroundResource(0);
                    mMediaStream.setDgree(getDgree());
                    mMediaStream.createCamera();
                    mMediaStream.startPreview();
                    ...
                    svSmall.setBackground(getResources().getDrawable(R.drawable.easy_logo));
                }
                break;
     ...
     * @return
     */
    public void checkSettingAlertPermission(Context cxt) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            try {
                if (!Settings.canDrawOverlays(cxt)) {
                    Intent intent = new Intent(Settings.ACTION_MANAGE_OVERLAY_PERMISSION,
                            Uri.parse("package:" + cxt.getPackageName()));
    ...
    private void createDialog() {
        ...
        rlSmall = (RelativeLayout) inflater.inflate(R.layout.rl_small_window, null);
        svSmall = (SurfaceView) rlSmall.findViewById(R.id.sv_small);


        mWindowManager.addView(rlSmall, mParams);


//        LogUtil.e(tag, "touch_layout-->top:" + svSmall.getTop());
//        LogUtil.e(tag, "touch_layout-->bottom:" + svSmall.getBottom());

        //主动计算出当前View的宽高信息.
        svSmall.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
